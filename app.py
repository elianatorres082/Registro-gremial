...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if df_all.empty:
        ...
        with fc1:
            ...
            sel_sector = st.selectbox("Filtrar por Sector", sectores_disp)
        with fc2:
            delegados_filtrados = df_all if sel_sector == "Todos" else df_all[df_all["Sector"] == sel_sector]
            delegados = ["Todos"] + sorted(delegados_filtrados["Nombre y Apellido"].dropna().unique().tolist())
        ...
        df_f = df_all.copy()
        if sel_sector != "Todos":
            df_f = df_f[df_f["Sector"] == sel_sector]
        if sel_del != "Todos":
